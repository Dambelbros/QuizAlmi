    ...
    $.ajax({
        ...
        success: function(response){
            response.data.forEach(function(pregunta){
                ...
                tempSeis.append('<span class="mx-2"><a href="back_eliminar_pregunta.php?preg=' + pregunta._id + '"  class="white"><i class="bi bi-trash-fill"></a></i></span>')
                ...
                tempOcho.append('<div class="element-image border"></div>')
            });
        }
    })
})